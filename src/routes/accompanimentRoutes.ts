  ...
  try {
    const services = [
      ...
      },
      {
        ...
        description:
          "Facilitation des échanges et résolution des malentendus culturels",
        price: 60,
        currency: "EUR",
...
router.get("/request/:id", authenticate, async (req: AuthRequest, res) => {
  try {
    ...
    const request = {
      ...
      conversations: [
        ...
        },
        {
          ...
          type: "admin",
          message:
            "Bonjour, nous pouvons vous aider. Quels documents avez-vous?",
